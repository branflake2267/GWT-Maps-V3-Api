...
public class StreetViewPanoramaOptions extends JavaScriptObject {
	...
	/**
	 * Options defining the properties of a StreetViewPanorama object. use
	 * newInstance();
	 */
	 ...
	 * 
	 * @param addressControlOptions
	 *            {@link StreetViewAddressControlOptions}
	 */
	public final native void setAddressControlOptions(
	...
	/**
	 * sets The panorama ID, which should be set when specifying a custom
	 * panorama.
	 * 
	 * @param pano
	 */
	...
	/**
	 * gets The panorama ID, which should be set when specifying a custom
	 * panorama.
	 */
	...
	/**
	 * sets Custom panorama provider, which takes a string pano id and returns
	 * an object defining the panorama given that id. This function must be
	...
	private static StreetViewPanoramaData setPanoProviderImpl(String pano, int zoom, int tileX,
			int tileY, StreetViewPanoramaProvider provider) {
		StreetViewPanoramaData svpd = provider.getPanoData(pano, zoom, tileX, tileY);
		return svpd;
	}

	/**
	 * gets Custom panorama provider, which takes a string pano id and returns
	 * an object defining the panorama given that id. This function must be
	 * defined to specify custom panorama imagery.
	 */
	...
	/**
	 * gets The camera orientation, specified as heading, pitch, and zoom, for
	 * the panorama.
	 */
	...
	/**
	 * sets If false, disables scrollwheel zooming in Street View. The
	...
	/**
	 * gets If false, disables scrollwheel zooming in Street View. The
	 * scrollwheel is enabled by default.
	 */
