...
public class MapHandlerRegistration {
   ...
   * @param formatter
   */
  public static <E extends MapEvent<?, E>> HandlerRegistration addHandler(JavaScriptObject jso, MapEventType eventType,
   ...
   * @param formatter
   */
  public static <E extends MapEvent<?, E>> HandlerRegistration addHandlerMvc(JavaScriptObject jso,
   ...
   * @param formatter
   */
  public static <E extends MapEvent<?, E>> HandlerRegistration addHandlerDrawing(JavaScriptObject jso,
      MapEventType eventType, MapHandler<E> handler, MapEventFormatter<E> formatter) {
   ...
   * @param formatter
   */
  private static native <E extends MapEvent<?, E>> JavaScriptObject addHandlerImpl(JavaScriptObject jso,
   ...
   * @param formatter
   */
  private static native <E extends MapEvent<?, E>> JavaScriptObject addHandlerImplMvc(JavaScriptObject jso,
      String eventName, MapHandler<E> handler, MapEventFormatter<E> formatter) /*-{
		var callback = function(event) {
			var eventCon = {
				index : event
   ...
   * @param formatter
   */
  private static native <E extends MapEvent<?, E>> JavaScriptObject addHandlerImplDrawing(JavaScriptObject jso,
      String eventName, MapHandler<E> handler, MapEventFormatter<E> formatter) /*-{
		var callback = function(event) {
			var eventCon = {
				overlay : event
   ...
   * @param formatter
   */
  protected static <E extends MapEvent<?, E>> void onCallback(final MapHandler<E> handler, final Properties properties,
   ...
   * @param formatter
   */
  private static <E extends MapEvent<?, E>> void formatEvent(MapHandler<E> handler, Properties properties,
  ...
  /**
   * experimental for the moment. I'm not satisfied as of yet with this
   * strategy.
   * 
  ...
  private static native <E> void addDomListener(JavaScriptObject object, String eventName, MapHandler<?> handler,
      boolean capture) /*-{
		...
		$wnd.google.maps.event.addDomListener(object, eventName, callback,
				capture);
  }-*/;
