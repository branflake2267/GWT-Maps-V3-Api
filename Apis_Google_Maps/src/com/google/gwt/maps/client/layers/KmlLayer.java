...
/**
 * A KmlLayer adds geographic markup to the map from a KML, KMZ or GeoRSS file
 * that is hosted on a publicly accessible web server. A KmlFeatureData object
 * is provided for each feature when clicked. This class extends MVCObject. <br>
 * <br>
 * See <a href=
...
public class KmlLayer extends MVCObject<KmlLayer> {
	...
	/**
	 * Creates a KmlLayer which renders the contents of the specified KML/KMZ
	 * file (<a
	 * href="https://developers.google.com/kml/documentation/kmlreference">KML
	 * API Doc</a>) or GeoRSS file (<a href="http://www.georss.org">GeoRSS API
	 * Doc</a>).
	 * 
	 * @param url
	 * @param options
	 *            {@link KmlLayerOptions}
	 ...
	 * @param handler
	 */
	public final HandlerRegistration addDefaultViewportChangeHandler(
			DefaultViewportChangeMapHandler handler) {
		return MapHandlerRegistration.addHandler(this, MapEventType.DEFAULTVIEWPORT_CHANGED,
				handler, new DefaultViewportChangeEventFormatter());
	}
