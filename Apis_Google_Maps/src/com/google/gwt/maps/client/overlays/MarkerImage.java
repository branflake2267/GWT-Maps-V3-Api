...
public class MarkerImage extends JavaScriptObject {
   ...
   * creates A structure representing a Marker icon or shadow image.
   * @param url The URL of the image or sprite sheet.
   * @param size The display size of the sprite or image. When using sprites, you must specify the sprite size. If the size is not provided, it will be set when the image loads.
   * @return {@link MarkerImage}
   */
   ...
   * @param url The URL of the image or sprite sheet.
   * @param size The display size of the sprite or image. When using sprites, you must specify the sprite size. If the size is not provided, it will be set when the image loads.
   * @param origin The position of the image within a sprite, if any. By default, the origin is located at the top left corner of the image (0, 0).
   * @return {@link MarkerImage}
   */
   ...
   * @param size The display size of the sprite or image. When using sprites, you must specify the sprite size. If the size is not provided, it will be set when the image loads.
   * @param origin The position of the image within a sprite, if any. By default, the origin is located at the top left corner of the image (0, 0).
   * @param anchor The position at which to anchor an image in correspondance to the location of the marker on the map. By default, the anchor is located along the center point of the bottom of the image.
   * @return {@link MarkerImage}
   */
   ...
   * @param origin The position of the image within a sprite, if any. By default, the origin is located at the top left corner of the image (0, 0).
   * @param anchor The position at which to anchor an image in correspondance to the location of the marker on the map. By default, the anchor is located along the center point of the bottom of the image.
   * @param scaledSize The size of the entire image after scaling, if any. Use this property to stretch/shrink an image or a sprite.
   * @return {@link MarkerImage}
   */
  ...
  private final static native JavaScriptObject createJso(String url, Size size, Point origin, Point anchor, Size scaledSize) /*-{
