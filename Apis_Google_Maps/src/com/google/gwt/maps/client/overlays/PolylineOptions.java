...
public class PolylineOptions extends JavaScriptObject {
	...
	/**
	 * sets The ordered sequence of coordinates of the Polyline. This path may
	 * be specified using either a simple array of LatLngs, or an MVCArray of
	...
	/**
	 * gets The ordered sequence of coordinates of the Polyline. This path may
	 * be specified using either a simple array of LatLngs, or an MVCArray of
	 * LatLngs. Note that if you pass a simple array, it will be converted to an
	 * MVCArray Inserting or removing LatLngs in the MVCArray will automatically
	 * update the polyline on the map.
