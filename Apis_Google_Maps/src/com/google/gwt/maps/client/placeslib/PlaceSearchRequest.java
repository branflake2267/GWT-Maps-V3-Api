...
public class PlaceSearchRequest extends JavaScriptObject {
	 ...
	 * least one of the specified types in this array. Valid types are given <a
	 * href=
	 * "https://developers.google.com/maps/documentation/places/supported_types"
	 * >here</a>. TODO add more AutocompleteType enums down the road. Otherwise
	 * use the setTypes(JsArrayString)
	 * 
	 * @param types
	 */
