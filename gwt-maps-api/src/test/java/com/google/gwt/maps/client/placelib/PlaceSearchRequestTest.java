...
public class PlaceSearchRequestTest extends AbstractMapsGWTTestHelper {
	...
	public void testAC() {
		asyncLibTest(new Runnable() {
			...
			public void run() {
				...
				JsArray<GeocoderAddressComponent> left = ArrayHelper
						.toJsArray(a);
				o.setAddress_Components(left);
				JsArray<GeocoderAddressComponent> right = o
	...
	public void testgeomtry() {
		...
		asyncLibTest(new Runnable() {
			...
			public void run() {
				...
				assertEquals(left.getLocation().getToString(), right
						.getLocation().getToString());
				finishTest();
			}
		});
	}
