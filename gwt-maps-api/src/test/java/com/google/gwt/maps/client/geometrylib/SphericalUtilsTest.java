...
public class SphericalUtilsTest extends AbstractMapsGWTTestHelper {
	...
	public void testComputeOffset() {
		asyncLibTest(new Runnable() {
			...
			public void run() {
				...
				int distance = 2006;
				int heading = 45;
				LatLng offset = SphericalUtils.computeOffset(from, distance,
						heading);
	...
	public void testInterpolate() {
		asyncLibTest(new Runnable() {
			...
			public void run() {
				...
				assertEquals("(49.99774917449739, -103.15105034281981)",
						ll.getToString());
				finishTest();
			}
		});
