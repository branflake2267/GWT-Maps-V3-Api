	...
	public void testCenter() {
		asyncLibTest(new Runnable() {
			...
			public void run() {
				...
				assertEquals(MapOptions.DEFAULT_LATLNG_LAT,
						pretest.getLatitude(), 1e2);
				assertEquals(MapOptions.DEFAULT_LATLNG_LNG,
						pretest.getLongitude(), 1e2);
	...
	public void testMapTypeControlOptions() {
		asyncLibTest(new Runnable() {
			...
			public void run() {
				...
				// should get default value if name is correct
				MapTypeControlOptions pretest = options
	...
	public void testOverviewMapControlOptions() {
		asyncLibTest(new Runnable() {
			...
			public void run() {
				...
				// should get default value if name is correct
				OverviewMapControlOptions pretest = options
	...
	public void testRotateControlOptions() {
		asyncLibTest(new Runnable() {
			...
			public void run() {
				...
				// should get default value if name is correct
				RotateControlOptions pretest = options
	...
	public void testStreetViewControlOptions() {
		asyncLibTest(new Runnable() {
			...
			public void run() {
				...
				// should get default value if name is correct
				StreetViewControlOptions pretest = options
