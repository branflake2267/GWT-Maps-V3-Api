...
public class MapWidgetTest extends AbstractMapsGWTTestHelper {
	...
	public void testFitBounds() {
		asyncLibTest(new Runnable() {
			...
			public void run() {
				...
				assertEquals(
						"((30.792110938675897, 108.28193299999998), (51.64751462536006, 108.28193299999998))",
						right.getToString());
				finishTest();
			}
		});
	...
	public void testGetPanBy() {
		asyncLibTest(new Runnable() {
			...
			public void run() {
				...
				assertEquals("(-41.53468367361192, 61.31249999999999)",
						latlng.getToString());
				finishTest();
			}
		});
	...
	public void testPanTo() {
		asyncLibTest(new Runnable() {
			...
			public void run() {
				...
				o.panTo(latLng);
				LatLng latlng = o.getCenter();
				assertEquals("(35.29999999999999, 38.49999999999998)",
						latlng.getToString());
				finishTest();
			}
		});
	...
	public void testPanToBounds() {
		asyncLibTest(new Runnable() {
			...
			public void run() {
				...
				assertEquals("(32.92888675928454, -71.33424200000006)",
						center.getToString());
				finishTest();
			}
		});
