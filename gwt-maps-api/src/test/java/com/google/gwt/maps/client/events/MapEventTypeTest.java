...
public class MapEventTypeTest extends AbstractMapsGWTTestHelper {
	...
	public void testUseMap() {
		...
		// 10. map
		assertEquals("maptypeid_changed",
				MapEventType.MAPTYPEID_CHANGED.value());
		...
		// 14. map
		assertEquals("projection_changed",
				MapEventType.PROJECTION_CHANGED.value());
