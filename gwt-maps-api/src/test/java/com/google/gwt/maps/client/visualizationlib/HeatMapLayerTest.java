...
public class HeatMapLayerTest extends AbstractMapsGWTTestHelper {
	...
	public void testSetDataLatLngJsArray() {
		asyncLibTest(new Runnable() {
			...
			public void run() {
				...
				/*
				 * // ensure we can read back the map value and that it is
				 * correct // foo data JsArray<LatLng> expected =
				 * getJsLatLngArrayData();
				 * 
				 * layer.setData(expected); actual = layer.getData();
				 * 
				 * assertEquals(expected.length(), actual.getLength());
				 * assertEquals(expected.get(0).toString(),
				 * actual.get(0).toString()); // test clearing from map
				 * JsArray<LatLng> emptySet = ArrayHelper.toJsArray(new
				 * LatLng[]{}); layer.setData(emptySet); actual =
				 * layer.getData(); assertEquals(0, actual.getLength());
				 */
				finishTest();
			}
		});
	...
	public void testSetDataWeightedLocationJsArray() {
		asyncLibTest(new Runnable() {
			...
			public void run() {
				 ...
				 * correct
				 * 
				 * // foo data JsArray<WeightedLocation> expected =
				 * getJsWeightedArrayData(); layer.setDataWeighted(expected);
				 * actual = layer.getDataWeighted();
				 * 
				 * assertEquals(expected.length(), actual.getLength());
				 * assertEquals(expected.get(0).toString(),
				 ...
				 * 
				 * // test clearing from map JsArray<WeightedLocation> emptySet
				 * = ArrayHelper.toJsArray(new WeightedLocation[]{});
				 * layer.setDataWeighted(emptySet); actual =
				 * layer.getDataWeighted(); assertEquals(0, actual.getLength())
				 */;
	...
	private static LatLng[] getLatLngData() {
		LatLng[] data = new LatLng[] { LatLng.newInstance(37.782551d, -122.445368d),
				LatLng.newInstance(37.782745d, -122.444586d),
				LatLng.newInstance(37.782842d, -122.443688d),
				LatLng.newInstance(37.782919d, -122.442815d),
				LatLng.newInstance(37.782992d, -122.442112d),
				LatLng.newInstance(37.783100d, -122.441461d),
				LatLng.newInstance(37.783206d, -122.440829d),
				LatLng.newInstance(37.783273d, -122.440324d),
				LatLng.newInstance(37.783316d, -122.440023d),
				LatLng.newInstance(37.783357d, -122.439794d),
				LatLng.newInstance(37.783371d, -122.439687d),
				LatLng.newInstance(37.783368d, -122.439666d),
				LatLng.newInstance(37.783383d, -122.439594d),
				LatLng.newInstance(37.783508d, -122.439525d),
				LatLng.newInstance(37.783842d, -122.439591d),
				LatLng.newInstance(37.784147d, -122.439668d),
				LatLng.newInstance(37.784206d, -122.439686d),
				LatLng.newInstance(37.784386d, -122.439790d),
				LatLng.newInstance(37.784701d, -122.439902d),
				LatLng.newInstance(37.784965d, -122.439938d),
				LatLng.newInstance(37.785010d, -122.439947d),
				LatLng.newInstance(37.785360d, -122.439952d),
				LatLng.newInstance(37.785715d, -122.440030d),
				LatLng.newInstance(37.786117d, -122.440119d),
				LatLng.newInstance(37.786564d, -122.440209d),
