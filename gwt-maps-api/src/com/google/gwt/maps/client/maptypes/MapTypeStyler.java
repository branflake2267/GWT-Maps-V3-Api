 ...
 * >MapTypeStyler API Doc</a>
 */
public class MapTypeStyler extends JavaScriptObject {

	/**
	 * A styler affects how a map's elements will be styled. Each MapTypeStyler
	 * should contain one and only one key. If more than one key is specified in
	 * a single MapTypeStyler, all but one will be ignored. For example: var
	 * rule = {hue: '#ff0000'}. use newInstance();
	 */
	 ...
	 * values: Floating point numbers, [0.01, 10], with 1.0 representing no
	 * change.
	 * 
	 * @param gamma
	 *            [0.01,10]
	 ...
	 * decreasing and a percentage of the remaining value if increasing. Valid
	 * values: [-100, 100].
	 * 
	 * @param lightness
	 *            [-100,100]
	 ...
	 * A value of true will invert the lightness of the feature while preserving
	 * the hue and saturation.
	 * 
	 * @param invertLightness
	 */
	public final static MapTypeStyler newInvertLightnessStyler(
	 ...
	 * Shifts the saturation of colors by a percentage of the original value if
	 * decreasing and a percentage of the remaining value if increasing. Valid
	 * values: [-100, 100].
	 * 
	 * @param saturation
	 *            [-100, 100]
	 */
	public final static MapTypeStyler newSaturationStyler(
			int saturation) {
		MapTypeStyler styler = JavaScriptObject.createObject().cast();
	...
	/**
	 * sets Gamma. Modifies the gamma by raising the lightness to the given
	...
	/**
	 * gets Gamma. Modifies the gamma by raising the lightness to the given
	 * power. Valid values: Floating point numbers, [0.01, 10], with 1.0
	 * representing no change.
	 */
	...
	/**
	 * sets Sets the hue of the feature to match the hue of the color supplied.
	 * Note that the saturation and lightness of the feature is conserved, which
	 * means that the feature will not match the color supplied exactly. Valid
	 * values: An RGB hex string, i.e. '#ff0000'.
	 * 
	 * @param hue
	...
	/**
	 * sets Inverts lightness. A value of true will invert the lightness of the
	...
	/**
	 * gets Inverts lightness. A value of true will invert the lightness of the
	 * feature while preserving the hue and saturation.
	 */
	...
	/**
	 * sets Lightness. Shifts lightness of colors by a percentage of the
	...
	/**
	 * gets Lightness. Shifts lightness of colors by a percentage of the
	 * original value if decreasing and a percentage of the remaining value if
	 * increasing. Valid values: [-100, 100].
	 */
	...
	/**
	 * sets Saturation. Shifts the saturation of colors by a percentage of the
	 * original value if decreasing and a percentage of the remaining value if
	 * increasing. Valid values: [-100, 100].
	 * 
	 * @param saturation
	...
	/**
	 * gets Saturation. Shifts the saturation of colors by a percentage of the
	 * original value if decreasing and a percentage of the remaining value if
	 * increasing. Valid values: [-100, 100].
	 */
