...
public class DrawingManagerOptions extends JavaScriptObject {
	...
	/**
	 * Options to apply to any new circles created with this DrawingManager. The
	 * center and radius properties are ignored, and the map property of a new
	 * circle is always set to the DrawingManager's map.
	 * 
	 * @param circleOptions
	 */
	 ...
	 */
	public final native void setDrawingControlOptions(
	 ...
	 * be added on the map. Accepted values are MARKER, POLYGON, POLYLINE,
	 * RECTANGLE, CIRCLE, or null. A drawing mode of null means that the user
	 * can interact with the map as normal, and clicks do not draw anything.
	 * 
	 * @param drawingMode
	 */
	...
	/**
	 * Options to apply to any new markers created with this DrawingManager. The
	 * position property is ignored, and the map property of a new marker is
	 ...
	 */
	public final native void setRectangleOptions(
