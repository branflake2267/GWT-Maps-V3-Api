...
public class DirectionsService extends JavaScriptObject {
	 ...
	 * 
	 * TODO I can't test this in dev mode, but seems to be working in production
	 * deployed. maps api can't find <__gwt_ObjectId>
	 * 
	 * @param request
	 * @param handler
	 */
	public final native void route(DirectionsRequest request,
	...
	private static final void routeImpl(DirectionsResult result, String status,
			DirectionsResultHandler handler) {
