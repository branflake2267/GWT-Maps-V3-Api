 ...
 * <br>
 * See <a href=
 * "https://developers.google.com/maps/documentation/javascript/reference#DrawingControlOptions"
...
public class DrawingControlOptions extends JavaScriptObject {
	...
	private static DrawingControlOptions setDefaults(DrawingControlOptions obj) {
		...
		obj.setDrawingModes(OverlayType.MARKER, OverlayType.POLYLINE, OverlayType.RECTANGLE, OverlayType.CIRCLE, OverlayType.POLYGON);
		return obj;
	}
	 ...
	 * array. Defaults to [MARKER, POLYLINE, RECTANGLE, CIRCLE, POLYGON]. hmmmm,
	 * this seems a bit overlay iterative
	 * 
	 * @param overlayTypes
	 */
	 ...
	 * which they are to be displayed. The hand icon (which corresponds to the
	 * null drawing mode) is always available and is not to be specified in this
	 * array. Defaults to [MARKER, POLYLINE, RECTANGLE, CIRCLE, POLYGON].
	 */
