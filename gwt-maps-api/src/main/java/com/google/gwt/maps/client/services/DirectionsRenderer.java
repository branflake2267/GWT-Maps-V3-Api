 ...
 * retrieved from the DirectionsService. This class extends MVCObject. <br>
 * <br>
 * See <a href=
...
public class DirectionsRenderer extends MVCObject<DirectionsRenderer> {
	 ...
	 * @param options
	 */
	public static final DirectionsRenderer newInstance(
	...
	/**
	 * Returns the panel <code>&lt;div&gt;</code> in which the DirectionsResult
	 * is rendered.
	 */
	 ...
	 * render. By default, the first route in the array will be rendered.
	 * 
	 * @param routeIndex
	 */
	 ...
	 * @param handler
	 */
	public final HandlerRegistration addDirectionsChangeHandler(
			DirectionsChangeMapHandler handler) {
		return MapHandlerRegistration.addHandler(this,
				MapEventType.DIRECTIONS_CHANGED, handler,
