 ...
 * <br>
 * See <a href=
 * "https://developers.google.com/maps/documentation/javascript/reference#AdUnitOptions"
 * >AdUnitOptions API Doc</a>
 */
public class AdUnitOptions extends JavaScriptObject {
	 ...
	 * this AdUnit. It must be stored as a string as it will typically be a
	 * large UINT64. (Optional)
	 */
	...
	/**
	 * The map associated with this AdUnit. Ads will be targeted to the location
	 * the map's viewport. (Required)
	 */
	...
	/**
	 * The position of the AdUnit. If specified, the AdUnit will be displayed at
	 * this position. Otherwise, it will not be added to the map. (Optional)
	 */
	...
	/**
	 * Your AdSense for Content publisher ID. Required and must be set at the
	 * time of initialization. (Required)
	 */
	 ...
	 * of this AdUnit. It must be stored as a string as it will typically be a
	 * large UINT64. (Optional)
	 * 
	 * @param channelNumber
	 */
